package ru.kildeev.market.carts.configs;
...
import ru.kildeev.market.carts.properties.ProductServiceIntegrationProperties;
...
public class AppConfig {
    ...
    @Bean
    public WebClient cartSertviceWebClient() {
